...
export const LenderForm = ({ initialData = null, onSubmit, isLoading = false, serverErrors = {} }) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            maxLength={10}
            className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 uppercase ${
